...
The first alternative model accounted for the overall generalism of a species by including among the predictors the magnitude of the number of species it interacts with across networks. 
The second alternative model, is highly prescriptive and accounts 
...
<!-- Induced by latitude (more generalism in tropics) or diversity (more generalism with high diversity or the opposite), See Baiser 2019 for refsuse network as a random effect. -->
