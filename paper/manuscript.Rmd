...
Thorugh this cleaning process, we removed with `r round(sum(n_dirty_occurrences$N)/1000000, digits = 1)` million occurrences accross `r n_species_with_dirty_occurrences` species. 

Because some of the occurrences are clustered across 
