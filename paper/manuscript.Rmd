...
After community composition has been determined, one way the environment can influence wether two species interact or not is by affecting their Eltonian-niche [@tylianakis_ecological_2017]. 
...
For instance @peralta_phylogenetic_2015 found that parasitoids in plantation forest, where enviornmental stress were higher than in native forests, were constrained to attack only hosts they were best adapted to. 
Similarly, @lavandero_genotype_2013 found that environmental stress due to higer temperature reduced the breadth of the Eltonian niche of parasitoids. 
The alternative hypotheis is that when species are under environmental stress they are forced
