...
Second, and most importantly, our results suggest that actually only a small proportion of species are "true generalists" or "true specialists" this is, species that interact with a large or small number of partners regardless of the environmental stress, respectively. 
This implies that rewiring is not exclusive of species with a large number of partners. 
...
However, there is a fourth group that remained invisible for our model but has important implications for network persistence and stability.
...
We propose this fourth group of is composed of true specialists that are constrained to interact with partners of high trait-matching and therefore were not likely to be found in more than one community. 
...
For specialist, at least, the longer-term benefits of being able to interact with multiple partners might be more important than the shorter-term benefits of interacting with partners of high trait matching. 
...
However, we show that many species are flexible in regards of their specialisation levels and therefore are not inherently generalists or specialists. 
Instead, species' level of specialisation/generalisation should be considered on a relative scale depending on where they are found and the environmental conditions at that location. 
