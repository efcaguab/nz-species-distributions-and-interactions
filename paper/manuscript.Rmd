...
fig_random_effects_legend <- 
  paste0("Species-level effects of suitability. (a) Conditional effect of suitability for individual species. To facilitate visualisation we show only species for which there is suitability information in at least six communities (", 
