...
We therefore removed from further analyses (NOTE XXX) `r n_spp_not_enough_occ` species for which we did not have enough occurrences to obtain robust estimates.
