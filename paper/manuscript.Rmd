...
The bayesian R-squared for our baseline model was `r round(bayesian_r2_baseline[1], digits = 2)`. 
Overall we found only weak evidence of a relationship between the environmental niche size and the normalised degree. 
