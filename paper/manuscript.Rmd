...
For instance some studies show that thropic interactions, like predation [@mckinnon_lower_2010; @vucic-pestic_warming_2011] and herbivory [@baskett_latitudinal_2018], can increase with temperature but might decreasse with precipitation [@pires_predicted_2016], and both plant-plant [@bertness_positive_1994] and plant-pollinator [@tur_evaluating_2016] interactions can switch from facilitative to competitive along a elevation/temperature gradient. 
...
After community composition has been established, one way the environment can influence whether two species interact or not is by affecting their Eltonian-niche [@tylianakis_ecological_2017]. 
This effect can happen through what we call stress/suitability-induced hypotheses of interaction turnover. 
The first hypothesis is that when species are under environmental stress, they might be "pressured" to focus on the partners with which they are best adapted to interact. 
