...
The predictors in the baseline model were the environmental stress, its number of known possible partners in the commuynity, and both the species guild (plant or a pollinator) and its interaction with environmental stress.
...
First, it allows us to inspect the extent to which environmental stress affects species in a similar fashion. 
