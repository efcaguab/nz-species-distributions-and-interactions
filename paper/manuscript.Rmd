...
Nevertheless results were qualitatively the same if instead we model the normalised degree (REF Martin Gonzalez 2010) using a binomial distribution in which degree is the number of successes and the number of species in the opposite guild is the number of trials (Supp info). 
