...
While a large proportion of the interactions appear to be opportunistic, a fraction of interactions show a strong signature of deep co-evolutionary history [@hutchinson_cophylogenetic_2017]. 
...
Although less understood, the environment can also affect the interactions, once community composition has been established [@tylianakis_ecological_2017]. 
...
One way to summarise the seemingly contradictory evidence of whether the environment can influence whether two species interact or not is by moving from gradients of temperature or precipitation to gradients of environmental stress/suitability. 
Previous research is so far equivocal and indicates that environmental stress can have two contrasting effects on species' Eltonian-niche [@tylianakis_ecological_2017].
...
For instance, @hoiss_interactive_2015 found that the specialization of plant-pollinator networks decreased both with elevation and after extreme drought events.
