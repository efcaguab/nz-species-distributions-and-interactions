...
For instance, @hoiss_interactive_2015 found that the specialisation of plant-pollinator networks decreased both with elevation and after extreme drought events.
...
We collect available data on plant-pollinator interactions globally and calculate the environmental suitability of all species present at two or more communities to. 
Our main aim is to leverage that information to test the two competing hypothesis that relate environmental stress and Eltionian niche breadth and whether there is a pattern within and across species. 
Specialist species have been found to be able to become "facultative" generalists to reduce their vulnerability to the absence of preferred partners [for example when phenologies are decoupled; @benadi_specialization_2014]. 
We therefore also expect that as environmental stress increasses species with a relatively small number of partners are more likely to broaden their Eltonian niche. 
