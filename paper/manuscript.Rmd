...
From the remaining `r format(n_sp_names_sp_level - n_sp_correct_in_data, big.mark = ",")` names, we were able to identify and the correct missspelling of `r format(n_sp_corrected_typos, big.mark = ",")` organism names. 
