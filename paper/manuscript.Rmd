...
We retrieved `r round(sum(n_occurrences$N)/1000000, digits = 1)` million occurrences of our focal species from the Global Biodiversity Information Facility `r occ_cit`. 
...
Our results suggest that changes in community composition are indeed the primary channel through which the environment determines changes interaction probability, and this is a common mechanism through which ecological networks respond to environmental change [@tylianakis_ecological_2017]. 
