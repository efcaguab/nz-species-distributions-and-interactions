...
Interestingly, the slope of this relationship correlates positively with the species' intercept in the model (Figure \@ref(fig:fig-random-effects)b and c). 
The mean correlation coefficient was `r round(random_cor$Estimate, 2)` [`r round(random_cor$Q2.5, 2)`, `r round(random_cor$Q97.5, 2)`].
In other words, the slope of the stress-specialisation relationship was more likely to be positive for species with a smaller number of partners in and negative for species with a larger number of partners in lower-suitability conditions.
