...
Our next step was to determine the habitat suitability of the `r format(nrow(readd(spp_to_download)), big.mark = ',')` species that were present in at least `r numbers2words(readd(minimum_spp_locations))` communities.
...
This resulted into roughly `r round(sum(readd(n_occurrences)$N)/1000000, digits = 1)` million occurrences. 
