...
To determine the environmental niche of each species we use a principal component analysis of the 37 bioclimatic variables associated with the species occurrences. 
...
We use the first two components to define the environmental space. 
We then  The use of a kernel smoother makes the process of moving from geographical space to multivariate environmental space independent of both sam- pling effort and arbitrary choice of resolution in environmental space
