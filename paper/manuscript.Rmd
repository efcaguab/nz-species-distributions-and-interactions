...
We found that for some species, there is a strong negative relationship between stress and specialisation, while for others, there is a strong positive relationship (Figure \@ref(fig:fig-random-effects)a). 
Interestingly, the slope of these relationships was correlated with the species' specialisation intercepts in the model (Figure \@ref(fig:fig-random-effects)b and c). 
The mean correlation coefficient was `r round(random_cor$Estimate, 2)` [`r round(random_cor$Q2.5, 2)`, `r round(random_cor$Q97.5, 2)`] (95% credible intervals shown within square brackets).
...
The variability of the specialisation-stress relationship across species was also evident when looking at overall patterns.
...
Unfortunately it is not straigtforward to explicitly account for this fourth group.
...
How to distinguish these two processes (often termed Eltonian and Grinellian, niches respectively) is stil an open area of res [@gravel_bringing_2018]
