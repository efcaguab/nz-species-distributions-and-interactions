...
It has been proposed that some of variation can be attributed to environmental drivers. 
However, how exactly the environment, and the stress it imposes, affects the turnover of interactions is still unknown. 
It is crucial to understand why and how this turnover occur because the network of interactions of an ecological community is known to underpin ecosystem function and stability. 
...
Therefore, it is not surprising that multiple studies have shown how changes to interactions, both pairwise and at the community level, can be driven by environmental change [@tylianakis_ecological_2017].
