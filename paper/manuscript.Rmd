...
To calculate the suitability of a species in a particular location, using a (grinellian) niche-factor analysis [@hirzel_ecological-niche_2002; @broennimann_measuring_2012] which is based on the probabiliy density function of a species distribution in an environmental-bioclimatic variable space. 
Calculating this we To do that we first fit a climatic envelope for each  of them which requires information about the climate and habitat at the locations where the species occurrs. 
