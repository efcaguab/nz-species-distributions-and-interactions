...
Within each model set we evaluate several candidate models in order to evaluate the relative importance of suitability. 
A first model included suitability and guild as population effects and two grouping levels, species and the community. 
Our main predictor, the environmental suitability of the species in that particular community, is an index defined betwen zero and one in which a value of zero indicates that the species has never been observed in this environment while a value of one indicates that the species is most commonly observed in that environment. 
...
A second model accounted for the overall generalism of a species by also including among the predictors the magnitude of the total number of interacting species across networks. 
Finally, a third alternative model included the overall species generalism but excluded the effect of environmental suitability both at the population and the species level. 
...
We found that environmental suitability is an important variable 
