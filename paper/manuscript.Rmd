...
On one end of the spectrum, generalist are have traits that allow them to intract a large number of species.
...
This is so because, on the other end of the spectrum, specialist species tend to have a have deeper co-evolutionary history with their partner species. 
This in turn is reflected on a better trait-matching with the species it interacts with which leads to a higher benefit.
