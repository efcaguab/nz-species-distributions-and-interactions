...
We then tried to retrieve occurrences for `r format(nrow(readd(spp_to_download)), big.mark = ',')` species that were present in at least `r numbers2words(readd(minimum_spp_locations))` communities in our dataset. 
